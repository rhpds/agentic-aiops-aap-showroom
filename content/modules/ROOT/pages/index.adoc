...
This workshop consists of four independent parts:
...
- *Part 4: AI-Driven Incident Response with MCP* - 30-40 minutes
...
[NOTE]
====
**This lab has multiple independent parts!** You can complete them in any order. If you've already completed Part 1 and want to explore a more advanced scenario, skip ahead to Part 2 or Part 4.
====
...
[IMPORTANT]
====
**The next evolution of AIOps.** Part 4 takes you beyond static playbooks and pre-built workflows into *agentic automation* -- where intelligent agents reason, decide, and act through Ansible Automation Platform as their trusted execution layer.
====

Part 4 explores three progressively autonomous approaches to AI-driven automation:

* *Human-in-the-loop*: Use Claude Code with MCP to interactively query and control AAP through natural language
* *Autonomous agents*: Run CrewAI agents that independently triage, remediate, and report on incidents
* *Event-driven AI*: Combine Event-Driven Ansible with AI agents in AAP workflows for end-to-end automated response

You will design and deploy agentic workflows that interpret alerts, gather context, and trigger self-healing automation -- all while maintaining human oversight and auditability.

=== What you will learn

* How the Model Context Protocol (MCP) exposes AAP capabilities to AI models
* The difference between human-in-the-loop and autonomous AI automation patterns
* How to combine Event-Driven Ansible with AI agents for closed-loop remediation
* How the automation orchestrator, an exciting new feature coming to Ansible Automation Platform, will unify agents and playbooks natively
...
**Part 4: AI-Driven Incident Response with MCP** (Module 7)

The next evolution -- move beyond static playbooks to **agentic automation** where AI agents reason, decide, and act through AAP as the trusted execution layer.
|===

[TIP]
====
**Choose your path:** All parts are independent and can be completed in any order. New to AIOps? Start with Part 1. Want to explore agentic AI automation? Jump to Part 4.
====
