...
The *Ansible Automation Platform Orchestrator* is a new capability that enables AI agents to natively invoke governed automation through visual workflow design and unified audit trails. Ansible Automation Platform is not becoming an agent runtime or agent hosting platform -- it remains the *trusted execution layer* that agents call. The Orchestrator makes that integration seamless.
...
The Orchestrator enables a new class of automation workflows where AI agents invoke governed automation through Ansible Automation Platform:
...
The Ansible Automation Platform Orchestrator will make this integration native -- visual workflow design, unified audit trails, and seamless human-in-the-loop gates -- turning the creative engineering you saw today into governed, enterprise-ready simplicity.
